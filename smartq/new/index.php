...
smartQ API Credentials*/
 ...
 $strUrl = 'http://tcweb.smartqweb.com/api/v1/projects/22/tickets?count=1000';
...
foreach ($tickets['data']['items'] as $ticket) {
  ...
  $ticketid = $ticket['id'];
    echo "<tr>";
    echo "<td>";
    echo '<a href="javascript:poptastic(\'ticket-details-triage.php?pid='. $projectid .'&tid='. $ticketid .'\');">';
